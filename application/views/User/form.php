...
<div class="my-3 my-md-5">
  <div class="container">
      <div class="row">
          <div class="col-12">
              ...
              <div class="card-header">
                  ...
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#exampleModal" data-backdrop="static" data-keyboard="false">Select Groups</button>
                  ...
                  <div class="col-md-6 col-lg-6 col-sm-12">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12">
                      <div class="form-group">
                      <div class="col-sm-6">
                       <label for="input-type">Normal / Schedule Msg</label>
                              <div id="input-type" class="row">
                                  <div class="col-sm-6">
                                      <label class="radio-inline">
                                          <input name="schdule" id="schdule" value="1" type="radio" checked />Normal
                                      </label>
                                  </div>
                                  <div class="col-sm-6">
                                      <label class="radio-inline">
                                          <input name="schdule" id="schdule1" value="2" type="radio" />Schedule
                                      </label>
                                  </div>
                              </div>
                            </div>
          ...
          <!-- <div class="col-md-6 col-lg-6 col-sm-12 schdateClass" id="schtime" style="display: none;">
            <div class="form-group">
             <label class="form-label">Scheduled Time</label>
                <input type="time" class="form-control" id="timeformatExample1" name="stime" formaction="hh:mm">
            </div>
                </div> -->
               <div class="col-md-6 col-lg-6 col-sm-12 schdateClass" id="schdate" style="display: none;">
                          <div class="form-group">
                            <label class="form-label">Scheduled Date-time</label>
                            <input data-provide="datepicker" name="sdate" id="datetimepicke"data-date-autoclose="true" class="form-control">
                         </div>
                     </div>
