          ...
          <div class="container">
            ...
            <div class="row row-cards">
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/grant-ritchie-338179-500.jpg" alt="Photo by Nathan Guerrero" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/male/41.jpg)"></div>
                    <div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/ilnur-kalimullin-218996-500.jpg" alt="Photo by Alice Mason" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/female/1.jpg)"></div>
                    <div>
                      <div>Alice Mason</div>
                      <small class="d-block text-muted">12 days ago</small>
                    </div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/jakob-owens-224352-500.jpg" alt="Photo by Rose Bradley" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/female/18.jpg)"></div>
                    <div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/jeremy-bishop-330225-500.jpg" alt="Photo by Peter Richards" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/male/16.jpg)"></div>
                    <div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/jonatan-pie-226191-500.jpg" alt="Photo by Wayne Holland" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/male/26.jpg)"></div>
                    <div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/josh-calabrese-66153-500.jpg" alt="Photo by Michelle Ross" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/female/7.jpg)"></div>
                    <div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/joshua-earle-157231-500.jpg" alt="Photo by Debra Beck" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/female/17.jpg)"></div>
                    <div>
                      <div>Debra Beck</div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/mahkeo-222765-500.jpg" alt="Photo by Phillip Peters" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/male/30.jpg)"></div>
                    <div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/matt-barrett-339981-500.jpg" alt="Photo by Jack Ruiz" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/male/32.jpg)"></div>
                    <div>
                      <div>Jack Ruiz</div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/nathan-anderson-297460-500.jpg" alt="Photo by Ronald Bradley" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/male/9.jpg)"></div>
                    <div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/nathan-anderson-316188-500.jpg" alt="Photo by Kathleen Harper" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/female/8.jpg)"></div>
                    <div>
              ...
              <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                  <a href="javascript:void(0)" class="mb-3">
                    <img src="<?= base_url().'assets/user/' ?>demo/photos/nathan-dumlao-287713-500.jpg" alt="Photo by Bobby Knight" class="rounded">
                  </a>
                  <div class="d-flex align-items-center px-2">
                    <div class="avatar avatar-md mr-3" style="background-image: url(<?= base_url().'assets/user/' ?>demo/faces/male/4.jpg)"></div>
                    <div>
