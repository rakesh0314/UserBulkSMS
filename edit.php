 ...
 -->
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="fname" name="fname" placeholder="Enter Name....." value="<?php echo $user_data['name'] ?>" autocomplete="off">
                </div>

                <div class="form-group">
                  <label for="type">Type</label>
                  <input type="text" class="form-control" id="type" name="type"  value="<?php echo $user_data['type'] ?>" autocomplete="off">
                </div>
